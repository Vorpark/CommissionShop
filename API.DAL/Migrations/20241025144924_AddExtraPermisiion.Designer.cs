...
namespace API.DAL.Migrations
{
    ...
    [Migration("20241025144924_AddExtraPermisiion")]
    partial class AddExtraPermisiion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Domain.Models.Cart", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("dbbb30b9-ee12-41f0-ad68-b049316516a7")
                        });
                });
            ...
            modelBuilder.Entity("API.Domain.Models.OrderDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Domain.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6280c7f3-957a-448b-ae63-86dd6920f676"),
                            BrandId = 1,
                            CategoryId = 1,
                            CityId = 1,
                            CreatedDate = new DateTime(2024, 10, 25, 14, 49, 24, 85, DateTimeKind.Utc).AddTicks(6259),
                            Description = "WTF",
                            DiscountPercent = 0,
                            DiscountPrice = 0m,
                            HasDiscount = false,
                            ...
                            Price = 12455.01m,
                            SubCategoryId = 1,
                            UpdatedDate = new DateTime(2024, 10, 25, 14, 49, 24, 85, DateTimeKind.Utc).AddTicks(6260)
                        });
                });
            ...
            modelBuilder.Entity("API.Domain.Models.OrderDetail", b =>
                {
                    ...
                    b.HasOne("API.Domain.Models.Product", "Product")
                        ...
                        .HasForeignKey("API.Domain.Models.OrderDetail", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
